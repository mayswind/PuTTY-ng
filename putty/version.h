...
#define PUTTY_NG_BUILD "17"
#define BINARY_VERSION 0,68,66,17
...
#define TEXTVER "PuTTY-ng " VERSION_MAJOR "." VERSION_MINOR "." PUTTY_ND_VERSION_MAJOR "" PUTTY_ND_VERSION_MINOR "." PUTTY_NG_BUILD
