...
static ssh1_cipher *des3_ssh1_newobj(void)
{
...
static ssh1_cipher *des_ssh1_newobj(void)
{
...
{
    struct des_ssh1_ctx *ctx = FROMFIELD(cipher, struct des_ssh1_ctx, vt);
    des_3cbc_encrypt((unsigned char *)blk, len, ctx->contexts);
}

static void des3_ssh1_decrypt_blk(ssh1_cipher *cipher, void *blk, int len)
{
    struct des_ssh1_ctx *ctx = FROMFIELD(cipher, struct des_ssh1_ctx, vt);
    des_3cbc_decrypt((unsigned char *)blk, len, ctx->contexts+3);
}
...
{
    struct des_ssh1_ctx *ctx = FROMFIELD(cipher, struct des_ssh1_ctx, vt);
    des_cbc_encrypt((unsigned char *)blk, len, ctx->contexts);
}

static void des_ssh1_decrypt_blk(ssh1_cipher *cipher, void *blk, int len)
{
    struct des_ssh1_ctx *ctx = FROMFIELD(cipher, struct des_ssh1_ctx, vt);
    des_cbc_decrypt((unsigned char *)blk, len, ctx->contexts+1);
}
...
static ssh2_cipher *des3_ssh2_newobj(const struct ssh2_cipheralg *alg)
{
...
static ssh2_cipher *des_ssh2_newobj(const struct ssh2_cipheralg *alg)
{
...
void des_encrypt_xdmauth(const void *keydata, void *blk, int len)
{
    ...
    des_cbc_encrypt((unsigned char *)blk, len, &dc);
}
...
void des_decrypt_xdmauth(const void *keydata, void *blk, int len)
{
    DESContext dc;
    des_keysetup_xdmauth(keydata, &dc);
    des_cbc_decrypt((unsigned char *)blk, len, &dc);
}

static const struct ssh2_cipheralg ssh_3des_ssh2 = {
    des3_ssh2_newobj, des3_ssh2_free, des3_ssh2_setiv, des3_ssh2_setkey,
...
static const struct ssh2_cipheralg ssh_des_ssh2 = {
    des_ssh2_newobj, des_ssh2_free, des_ssh2_setiv, des_ssh2_setkey,
