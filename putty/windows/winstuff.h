...
void checkbox(struct ctlpos *cp, char *text, int id, int);
...
void dlg_editbox_set_hide(union control *ctrl, dlgparam *dlg, const int hide);
void dlg_show_ctrl(union control *ctrl, dlgparam *dlg, const int show);
