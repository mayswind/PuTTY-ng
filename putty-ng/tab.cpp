...
#include "ui_gfx/skbitmap_operations.h"
...
// static
const char Tab::kViewClassName[] = "browser/Tab";
...
void Tab::OnPaint(gfx::Canvas* canvas)
{
    ...
    SkColor title_color = SK_ColorBLACK;
...
void Tab::Layout()
{
    ...
    // child Views (for example, the Tab's close button which is a view::Button
...
bool Tab::GetTooltipTextOrigin(const gfx::Point& p, gfx::Point* origin)
{
    ...
    origin->set_y(-view::TooltipManager::GetTooltipHeight() - 4);
    return true;
}

void Tab::OnMouseMoved(const view::MouseEvent& event)
{
